...
def visualise_at_epoch(vis_sample, data, predict_labels, one_hot, epoch,
    ...
    if data == 'mnist':
        if predict_labels:
            ...
            labs, _ = np.mode(lab_votes, axis=1)
...
def save_plot_sample(samples, idx, identifier, n_samples=6, num_epochs=None, ncol=2):
    ...
    fig.savefig("./generative_models/rgan/experiments/plots/" + identifier + "_epoch" + str(idx).zfill(4) + ".png")
    plt.clf()
    plt.close()
    return
...
#     fig.savefig("./generative_models/rgan/experiments/plots/" + identifier + "_interpolate.png")
#     fig.savefig("./generative_models/rgan/experiments/plots/" + identifier + "_interpolate.pdf")
#     plt.clf()
#     plt.close()
#     return
...
#     plt.tight_layout()
#     plt.savefig('./generative_models/rgan/experiments/plots/' + identifier + '_reconstruction_errors.png')
#     return True
...
#     fig.subplots_adjust(hspace = 0.15)
#     fig.savefig("./generative_models/rgan/experiments/plots/" + identifier + "_reconstruct.png")
#     plt.clf()
#     plt.close()
#     return
...
#     fig.savefig('./generative_models/rgan/experiments/plots/' + identifier + '_eval' + str(idx).zfill(4) +'.png')
#     plt.clf()
#     plt.close()
#     return True
...
def plot_trace(identifier, xmax=250, final=False, dp=False):
    ...
    fig.savefig('./generative_models/rgan/experiments/traces/' + identifier + '_trace.png')
    fig.savefig('./generative_models/rgan/experiments/traces/' + identifier + '_trace.pdf')
    plt.clf()
    plt.close()
    return True
...
#     axarr[-1].set_xlabel("time since admission (hours)")
...
#     plt.savefig('./generative_models/rgan/experiments/plots/' + identifier + '_Z.png')
#     plt.clf()
#     plt.close()
#     return True
...
#     plt.tight_layout()
#     plt.savefig('./generative_models/rgan/experiments/plots/' + identifier + '_weights.png')
#     return True


def vis_eICU_patients_downsampled(
    pat_arrs, time_step, time_steps_to_plot=None,
    ...
    if not identifier is None:
        plt.suptitle(idx)
        fig.savefig("./generative_models/rgan/experiments/plots/" + identifier + "_epoch" + str(idx).zfill(4) + ".png", bbox_inches='tight')
    else:
        fig.savefig('./generative_models/rgan/experiments/plots/eICU_patients.png', bbox_inches='tight')
    plt.clf()
    plt.close()
    return True
...
#     plt.savefig('./generative_models/rgan/experiments/tstr/' + identifier + '_preds.png')
#     return True
...
#     plt.savefig("./generative_models/rgan/experiments/eval/eICU_marginals_" + label + ".png")
...
#     plt.tight_layout(pad=0.0, w_pad=-5.0, h_pad=0.1)
#     plt.savefig("./generative_models/rgan/experiments/eval/eICU_cristobal_marginals_r" + str(rep) + "_epoch" + str(epoch) + ".png")
...
#     plt.savefig("./generative_models/rgan/experiments/eval/eICU_cristobal_hist_r" + str(rep) + "_epoch" + str(epoch) + ".png")
